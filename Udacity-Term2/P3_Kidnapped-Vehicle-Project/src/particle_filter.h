...
public:
	...
	void pack_obsevations(std::vector<LandmarkObs>& noisy_observations, std::string sense_x, std::string sense_y);

	std::string getAssociations(Particle best);
	std::string getSenseX(Particle best);
	std::string getSenseY(Particle best);

	std::vector<std::vector<LandmarkObs> > observations_tmp_list; 
	/**
