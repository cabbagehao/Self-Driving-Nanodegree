    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2')
    {
      ...
      if (s != "") 
      {
        ...
        if (event == "telemetry") 
        {
          if (!pf.initialized())
          {
              // Sense noisy position data from the simulator, j[1] is the data JSON object
          ...
          pf.pack_obsevations(noisy_observations, sense_observations_x, sense_observations_y);
